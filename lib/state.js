...
function State(scope) {
  ...
  state = {
    ...
    prepareConfig: function (config) {
      ...
      scope.storage.setItem('_numVolumes', config.startOpts.Binds.length);
      scope.storage.setItem('_numLinks', config.startOpts.Links.length);
      scope.storage.setItem('_config', JSON.stringify(config));
      return config;
    },
